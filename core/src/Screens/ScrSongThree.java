...
public class ScrSongThree extends InputAdapter implements Screen {
    ...
    private String[] ars = new String[]{"TL", "BR", "BL", "BR", "TL", "TR", "BL", "BR", "BL", "TL", "TR", "TL", "BL", "BR", "BL", "TR", "TL", "BL", "TL"};

    public ScrSongThree(GamGame1 _game) {
        this.game = _game;
    }
